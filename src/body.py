...
class Body:
	...
	def __init__(self, name, mass, pos_x: int, pos_y: int, velocity_x, velocity_y, draw_radius, color, pos_to_screen_pos: MethodType, draw_forces = False):
		self.name = name
		...
		self.draw_forces: bool = draw_forces
